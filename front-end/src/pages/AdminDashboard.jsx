...
//                                   onClick={() => handleVerify(activeTab, user._id)}
...
//                                 onClick={() => setConfirmDelete({ role: activeTab, id: user._id, name: user.fullName })}
//                                 disabled={!!actionLoading}
//                               >
...
const handleReject = async (role, id) => {
  ...
  try {
    const res = await fetch(`${API}/deleteUser/${role}/${id}`, {
      method: "DELETE",
    });
