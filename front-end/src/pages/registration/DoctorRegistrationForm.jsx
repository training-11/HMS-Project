      ...
      <div className="hc-outer" style={{ width: "100%", minHeight: "100vh" }}>
        <div className="hc-bg">
          ...
          <div className="hc-card-wrap">
            <div
              className="card shadow-sm p-4 m-3"
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    <div style={{ fontSize: 11, color: "#888", marginTop: 3 }}>
                      Medical license, degree certificates, ID · PDF, JPG, PNG,
                      DOC · Max 10MB each
                    </div>
                  </div>
                  <input
        ...
        {showConfirm && (
          ...
          >
            ...
            >
              ...
              <p className="mb-1">
                You are registering as a <strong>Doctor</strong>.
              </p>
              {photoPreview && (
                <p className="mb-1" style={{ fontSize: 13, color: "#555" }}>
                  ✓ Profile photo attached
                </p>
              )}
              {documents.length > 0 && (
                <p className="mb-3" style={{ fontSize: 13, color: "#555" }}>
