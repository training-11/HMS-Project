...
function NurseRegistrationForm() {
  ...
  const snap = () => {
    ...
    canvas.toBlob((blob) => {
      const file = new File([blob], "nurse-photo.jpg", {
        type: "image/jpeg",
      });
    ...
    <>
      ...
      <div style={styles.page}>
        <div style={styles.card}>
          <h2 style={styles.title}>Nurse Sign Up</h2>
          ...
          <div style={styles.section}>
            ...
            >
              ...
              <option>Morning(6 A.M - 2 P.M)</option>
              <option>Evening(2 P.M-11 P.M)</option>
              <option>Night(10 P.M - 5 A.M)</option>
            </select>
        ...
        {showLoginConfirm && (
          <div style={styles.popupOverlay}>
            <div style={styles.popupBox}>
              <h4>Confirm Login</h4>
              <p>
                Are you sure you want to login as <b>Nurse</b>?
              </p>
